...
const { title: notTitle, author: notAuthor, libraryID: notLibraryID } = book2;

console.log(`The title of the book is ${notTitle}, the author is ${notAuthor}, and the library id is ${notLibraryID}`);
